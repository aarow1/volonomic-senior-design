function hijk = plotCoordinateFrameOff(o,R,n,c)
...
hi = plotVectorOff(o, i, c, ':', linewidth, nl{1}, fontsize);
hj = plotVectorOff(o, j, c, '--', linewidth, nl{2}, fontsize);
hk = plotVectorOff(o, k, c, '-', linewidth, nl{3}, fontsize);
